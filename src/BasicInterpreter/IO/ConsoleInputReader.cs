using System; // Import the System namespace to access Console class

namespace JesseFreeman.BasicInterpreter.IO
{
    /// <summary>
    /// The ConsoleInputReader class implements the IInputReader interface and provides a way to read input lines from the console.
    /// It allows the BasicInterpreter to read user input from the console when executing commands that require input from the user.
    /// </summary>
